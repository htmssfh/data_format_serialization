...
/**
 * Implements {@link DataJsonObject#toString} and {@link DataJsonArray#toString}. Most
 ...
 * output. To encode indented output, use {@link DataJsonObject#toString(int)} or
 * {@link DataJsonArray#toString(int)}.
 *
...
public class DataJsonStringer {
    ...
    enum Scope {
         ...
         * DataJsonObject.quote() only. Not used for JSON encoding.
         */
        NULL,
    }
    ...
    public DataJsonStringer() {
        indent = null;
    }

    DataJsonStringer(int indentSpaces) {
     ...
     */
    public DataJsonStringer array() throws JSONException {
     ...
     * @return this stringer.
     */
    public DataJsonStringer endArray() throws JSONException {
     ...
     * @return this stringer.
     */
    public DataJsonStringer object() throws JSONException {
     ...
     * @return this stringer.
     */
    public DataJsonStringer endObject() throws JSONException {
     ...
     * bracket.
     */
    DataJsonStringer open(Scope empty, String openBracket) throws JSONException {
     ...
     * given bracket.
     */
    DataJsonStringer close(Scope empty, Scope nonempty, String closeBracket) throws JSONException {
        Scope context = peek();
     ...
     * @return this stringer.
     */
    public DataJsonStringer value(Object value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }

        if (value instanceof DataJsonArray) {
            ((DataJsonArray) value).writeTo(this);
            return this;

        } else if (value instanceof DataJsonObject) {
            ((DataJsonObject) value).writeTo(this);
            return this;
        }
        ...
        if (value == null
                ...
                || value == DataJsonObject.NULL) {
            out.append(value);

        } else if (value instanceof Number) {
            out.append(DataJsonObject.numberToString((Number) value));
     ...
     * @return this stringer.
     */
    public DataJsonStringer value(boolean value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public DataJsonStringer value(double value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
        out.append(DataJsonObject.numberToString(value));
        return this;
    }
     ...
     * @return this stringer.
     */
    public DataJsonStringer value(long value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public DataJsonStringer key(String name) throws JSONException {
        if (name == null) {
