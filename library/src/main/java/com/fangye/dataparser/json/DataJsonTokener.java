 ...
 * this class will use only need the {@link #DataJsonTokener(String) constructor}
 ...
 *         + "}";
 *
 * DataJsonObject object = (DataJsonObject) new JSONTokener(json).nextValue();
 * String query = object.getString("query");
 * DataJsonArray locations = object.getDataJsonArray("locations");</pre>
 *
 * <p>For best interoperability and performance use JSON that complies with
 * RFC 4627, such as that generated by {@link DataJsonStringer}. For legacy reasons
...
public class DataJsonTokener {
     ...
     *     called.
     */
    public DataJsonTokener(String in) {
     ...
     *
     * @return a {@link DataJsonObject}, {@link DataJsonArray}, String, Boolean,
     *     Integer, Long, Double or {@link DataJsonObject#NULL}.
     ...
     */
    private DataJsonObject readObject() throws JSONException {
     ...
     */
    private DataJsonArray readArray() throws JSONException {
